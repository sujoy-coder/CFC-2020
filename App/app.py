...
from Server.ChartData import get_LineChartData,get_BarChartData,get_TableData
    ...
    if request.method== "POST":
        if 'predict' in request.form:
            ...
            if result != None:
                ...
                lineChartData = get_LineChartData(result[2],result[0])
                barChartData = get_BarChartData(result[2],result[1],result[3],result[4])
                tableData = get_TableData(result[2],result[0],result[1])
                lineChartData = json.dumps(lineChartData,cls=MyEncoder)
                ...
                return render_template('result.html',Date=Date,dayName=dayName,
                                        ...
                                        lineChartData=lineChartData,tableData=tableData,
